...
case 'objf'  % varargout = [ f, g, H ]
   ...
   varargout = opm_eval_cpsf( 'argauss', 'elobjf', x, eldom, nargout, y );

case 'consf'  % varargout = [ c, gc, Hc ]

   icon = varargin{1};
   x    = varargin{2};
   %  May call another CPS function in the current problem file, or just evaluate a non-CPS function
   %  varargout = opm_eval_cpsf( 'argauss', 'cons1f', x, eldom, nargout, varargin);
